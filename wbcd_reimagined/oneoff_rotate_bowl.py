...
"""
One-off script:
- load bowl mesh from mesh_dir/object_id
- rotate 90 degrees CCW about +X
- convert to mm
- save as bowl2.stl in mesh_dir
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Rotate bowl mesh and save as bowl2.stl")
    parser.add_argument(
        "--mesh_dir",
        type=str,
    ...
    parser.add_argument("--object_id", type=str, default="bowl")
    parser.add_argument("--output", type=str, default="bowl2.stl")
    ...
    # Convert to m (assume current units are mm).
