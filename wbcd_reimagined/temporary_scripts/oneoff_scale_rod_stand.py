...
"""
One-off script:
- rename rod_stant.stl -> rod_stand_original.stl
- scale mesh by 150% (1.5x) around bbox origin
- save as rod_stant.stl
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Scale rod_stand.stl by 1.5x and keep centered on bbox origin")
    parser.add_argument(
        "--mesh_dir",
        type=str,
        default="/home/kevin/ICL/rendering_prompted_muggled_sam/assets/mesh_0316",
    )
    parser.add_argument("--input", type=str, default="rod_stand.stl")
    parser.add_argument("--backup", type=str, default="rod_stand_original.stl")
    ...
    mesh.scale(1.5, center=[0.0, 0.0, 0.0])
